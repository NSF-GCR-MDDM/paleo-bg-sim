#Goal is to generate a README file documenting macro commands 
#automatically based on the PaleoSimMessenger.hh and PaleoSimMessenger.cc
import datetime
...
ccFile = open("../src/PaleoSimMessenger.cc","r")
hhFile = open("../include/PaleoSimMessenger.hh","r")
...
#Make README 
output = open("macro_commands.md", "w")
output.write("# Macro Command Options\n\n")
output.write("Automatically generated from PaleoSimMessenger.hh and PaleoSimMessenger.cc with genMacroDoc.py\n\n")
